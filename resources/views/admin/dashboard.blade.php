                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg">
                                    <div class="direct-chat-infos clearfix">
                                        <span class="direct-chat-name float-start"> {{ Auth::guard('admins')->user()->name }} </span>
                                        <span class="direct-chat-timestamp float-end"> {{ Auth::guard('admins')->user()->created_at }} </span>
                                    </div>
                                    <!-- /.direct-chat-infos -->
                                    <img
